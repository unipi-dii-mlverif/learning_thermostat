...
#    apt-get update && \
#    apt-get install -y python3.12 unzip && \
...
#RUN ln -s /usr/bin/python3.12 /bin/python 

# PyThorch
#RUN python3.12 -m pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cpu
...
RUN pip install grpcio scipy control filterpy tzdata pandas
